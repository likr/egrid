    ...
    (function (model) {
        ...
        var CollectionBase = (function () {
            function CollectionBase(pairs) {
                this.pairs_ = new egrid.model.ValueObject(pairs);
            }
    ...
    (function (model) {
        var Project = (function (_super) {
            ...
            Project.prototype.get = function (key) {
                var _this = this;
                return egrid.storage.get(Project.type, key).then(function (project) {
                    _this.load(project);
                });
            };
    ...
    (function (model) {
        var Collaborator = (function (_super) {
            ...
            Collaborator.listUrl = function (key) {
                return egrid.model.Project.listUrl() + '/' + key + '/collaborators';
            };
    ...
    (function (model) {
        var Participant = (function (_super) {
            ...
            Participant.listUrl = function (key) {
                return egrid.model.Project.listUrl() + '/' + key + '/participants';
            };
        ...
        var SemProject = (function (_super) {
            ...
            SemProject.prototype.save = function () {
                ...
                return $.ajax({
                    ...
                    var o = {};
                    var storageKey = 'unsavedItems.' + egrid.model.CollectionBase.pluralize(SemProject.type);
    ...
    (function (model) {
        var CollaboratorCollection = (function (_super) {
            ...
            CollaboratorCollection.prototype.query = function (projectKey) {
                return egrid.storage.retrieve(egrid.model.Collaborator.type, projectKey);
            };

            CollaboratorCollection.prototype.getItem = function (k) {
                var o = _super.prototype.getItem.call(this, k);
                return new egrid.model.Collaborator(o).load(o);
            };
    ...
    (function (model) {
        var ParticipantCollection = (function (_super) {
            ...
            ParticipantCollection.prototype.query = function (projectKey) {
                return egrid.storage.retrieve(egrid.model.Participant.type, projectKey);
            };
    ...
    (function (model) {
        var ProjectCollection = (function (_super) {
            ...
            ProjectCollection.prototype.query = function (key) {
                return egrid.storage.retrieve(egrid.model.Project.type);
            };
    ...
    (function (model) {
        var SemProjectCollection = (function (_super) {
            ...
            SemProjectCollection.prototype.query = function (projectKey) {
                return egrid.storage.retrieve(egrid.model.SemProject.type, projectKey);
            };
...
(function (egrid) {
    (function (app) {
        angular.module('collaboegm', ['paginator', 'ui.router', "ui.bootstrap", "pascalprecht.translate"]).directive('focusMe', [
            ...
            }]).value('alertLifeSpan', 3200).controller('CollaboratorCreateController', ['$q', '$rootScope', '$stateParams', '$state', '$timeout', '$filter', 'alertLifeSpan', egrid.app.CollaboratorCreateController]).controller('CollaboratorListController', ['$window', '$q', '$rootScope', '$stateParams', '$state', '$scope', '$modal', egrid.app.CollaboratorListController]).controller('ParticipantController', ['$window', '$q', '$rootScope', '$stateParams', '$state', '$scope', '$modal', '$timeout', '$filter', 'alertLifeSpan', egrid.app.ParticipantController]).controller('ParticipantCreateController', ['$q', '$rootScope', '$stateParams', '$state', '$timeout', '$filter', 'alertLifeSpan', egrid.app.ParticipantCreateController]).controller('ParticipantGridController', ['$window', '$q', '$rootScope', '$stateParams', '$state', '$scope', '$timeout', '$filter', 'alertLifeSpan', egrid.app.ParticipantGridController]).controller('ParticipantGridEditController', ['$window', '$q', '$rootScope', '$stateParams', '$state', '$scope', '$modal', '$timeout', '$filter', 'alertLifeSpan', egrid.app.ParticipantGridEditController]).controller('ParticipantListController', ['$window', '$q', '$rootScope', '$stateParams', egrid.app.ParticipantListController]).controller('ProjectController', ['$window', '$q', '$rootScope', '$stateParams', '$state', '$scope', '$modal', '$timeout', '$filter', 'alertLifeSpan', egrid.app.ProjectController]).controller('ProjectCreateController', ['$q', '$rootScope', '$state', '$timeout', '$filter', 'alertLifeSpan', egrid.app.ProjectCreateController]).controller('ProjectGridCreateController', ['$window', '$q', '$rootScope', '$stateParams', '$state', egrid.app.ProjectGridCreateController]).controller('ProjectGridEditController', ['$window', '$q', '$rootScope', '$stateParams', '$state', '$scope', '$modal', '$timeout', '$filter', 'alertLifeSpan', egrid.app.ProjectGridEditController]).controller('ProjectGridListController', ['$window', '$q', '$rootScope', '$stateParams', '$state', '$timeout', '$filter', 'alertLifeSpan', egrid.app.ProjectGridListController]).controller('ProjectListController', ['$window', '$q', '$rootScope', egrid.app.ProjectListController]).controller('SemProjectController', ['$window', '$q', '$rootScope', '$stateParams', '$state', '$timeout', '$filter', 'alertLifeSpan', egrid.app.SemProjectController]).controller('SemProjectAnalysisController', ['$window', '$q', '$rootScope', '$stateParams', egrid.app.SemProjectAnalysisController]).controller('SemProjectCreateController', ['$q', '$stateParams', '$state', '$timeout', '$filter', 'alertLifeSpan', egrid.app.SemProjectCreateController]).controller('SemProjectListController', ['$window', '$q', '$rootScope', '$stateParams', '$state', egrid.app.SemProjectListController]).controller('SemProjectQuestionnaireEditController', ['$window', '$q', '$rootScope', '$stateParams', egrid.app.SemProjectQuestionnaireEditController]).run([
