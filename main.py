...
app = webapp2.WSGIApplication([
    ...
    Route('/api/projects/<project_id:[\w\-]+>/analyses', AnalysisListHandler),
    Route('/api/projects/<project_id:[\w\-]+>/analyses/<analysis_id:[\w\-]+>', AnalysisHandler),
    Route('/api/projects/<project_id:[\w\-]+>/analyses/<analysis_id:[\w\-]+>/grid', AnalysisGridHandler),
    Route('/api/projects/<project_id:[\w\-]+>/analyses/<analysis_id:[\w\-]+>/questionnaire', AnalysisQuestionnaireHandler),
